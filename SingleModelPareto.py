...
def SingleModelParetoDT(dfPareto, fmPareto, fm1, sem_fm1, fm2, sem_fm2, fm3, sem_fm3, fm4, sem_fm4, fm5, sem_fm5, fm6, sem_fm6,
                        mts, ets,
                        min_samples_leaf, min_samples_split, max_features, criterion, class_weight, max_depth, df_tot, name) :
    ...
    fig1 = px.line(df, x="Accuracy", y=name, hover_data=['min_samples_leaf','min_samples_split','criterion','class weight','max_features','max_depth'], markers=True)
    ...
    fig2 = px.scatter(df_tot, x = "Accuracy", y = name, color='criterion', size='min_samples_split', symbol='class_weight',
                    hover_data=['min_samples_leaf','min_samples_split','criterion','class_weight','max_features','max_depth'])
    ...
    ntracesTOT = 1 + ntraces_a * 4 + ntraces_b * 2
    ...
    visibility_matrix = np.empty((6, len(visible)), dtype=bool)
    for i in range(6):
